...
type ComplexityRoot struct {
	...
	Query struct {
		Link func(childComplexity int, url string) int
	}
}
...
type QueryResolver interface {
	Link(ctx context.Context, url string) (*model.Link, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.link":
		...
		return e.complexity.Query.Link(childComplexity, args["url"].(string)), true
...
func (ec *executionContext) field_Mutation_createLink_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewLink2githubᚗcomᚋtclohmᚋlinkdropᚋgraphᚋmodelᚐNewLink(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createLink(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNLink2ᚖgithubᚗcomᚋtclohmᚋlinkdropᚋgraphᚋmodelᚐLink(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_link(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Link(rctx, args["url"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) marshalNLink2githubᚗcomᚋtclohmᚋlinkdropᚋgraphᚋmodelᚐLink(ctx context.Context, sel ast.SelectionSet, v model.Link) graphql.Marshaler {
	return ec._Link(ctx, sel, &v)
}

func (ec *executionContext) marshalNLink2ᚖgithubᚗcomᚋtclohmᚋlinkdropᚋgraphᚋmodelᚐLink(ctx context.Context, sel ast.SelectionSet, v *model.Link) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewLink2githubᚗcomᚋtclohmᚋlinkdropᚋgraphᚋmodelᚐNewLink(ctx context.Context, v interface{}) (model.NewLink, error) {
